...
if ($conn) {
    // 🎯 Securely query for payments awaiting rating
    $query = "SELECT ID FROM payment WHERE User_ID = ? AND Rating_Status = 'Received' ORDER BY PaymentStartedDate ASC LIMIT 1";
