...
(1, 'Jose Rizal St.', 'Poblacion', 'Talisay City');
...
CREATE TABLE `orders` (
  ...
  `Status` enum('Pending','Ongoing','Complete', 'Received') NOT NULL DEFAULT 'Pending',
...
CREATE TABLE `payment` (
  ...
  `Rating_Status` enum('NotReceived','Received','Rated') NOT NULL DEFAULT 'NotReceived'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
